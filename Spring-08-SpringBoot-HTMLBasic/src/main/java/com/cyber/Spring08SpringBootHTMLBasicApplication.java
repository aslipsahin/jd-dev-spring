...
public class Spring08SpringBootHTMLBasicApplication {
...
o	Other than this, DI; @Autowired, @Qualifier and @Value annotation usages are the same with JavaCode configuration.
		 ...
		 */
		ApplicationContext container = SpringApplication.run(Spring08SpringBootHTMLBasicApplication.class, args);
