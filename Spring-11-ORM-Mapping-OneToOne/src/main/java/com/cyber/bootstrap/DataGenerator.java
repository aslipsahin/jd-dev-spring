...
public class DataGenerator implements CommandLineRunner {
    ...
    //  In MVC i was storing this data in map, here i will store them in repository. that;s why i need to autowire the repos.
    @Autowired
...
//
//    //  Below i do not have to use @Autowired since it is a constructor injection but if it would be field injection
////    than i would
//    @Autowired
